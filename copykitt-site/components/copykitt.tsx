...
const CopyKitt: React.FC = () => {
    ...
    "text-white text-transparent bg-clip-text bg-gradient-to-r" +
          " from-teal-400 to-blue-500 font-light w-fit mx-auto";
      ...
      <div className="max-w-md m-auto p-2">
        <div className="bg-slate-800 p-6 rounded-md text-white">
          <div className="text-center my-6 ">
            <Image src={logo} width={42} height={42}  alt="Website logo"/>
